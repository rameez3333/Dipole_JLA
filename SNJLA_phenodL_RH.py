...
MLE = optimize.minimize(m2loglike, pre_found_best, method = 'SLSQP', tol=10**-10, options={'maxiter':2400000}, bounds=bnds)

print MLE

MCENoAcc = optimize.minimize(m2loglike, pre_found_best, method = 'SLSQP', constraints = ({'type':'eq', 'fun':m2NoAcc}, ), tol=10**-10,  bounds=bnds)
